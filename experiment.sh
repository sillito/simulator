...
node ./dist/service.js --config ../config/s3.json > $DIR/s3.metrics &
...
wrk -t 10 -c 2000 -d 15s -R 200 --timeout 15s -L http://127.0.0.1:3001/ > $DIR/wk1.output
wrk -t 10 -c 2000 -d 15s -R 200 --timeout 15s -L http://127.0.0.1:3002/ > $DIR/wk2.output
wrk -t 10 -c 2000 -d 15s -R 200 --timeout 15s -L http://127.0.0.1:3003/ > $DIR/wk3.output
